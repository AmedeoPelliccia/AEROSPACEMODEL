...
def main():
    ...
    tests = [
        test_commit_validator_valid_message,
        test_commit_validator_missing_sections,
        test_commit_validator_article_8_violation,
        test_commit_validator_article_8_with_reabsorption,
        test_commit_validator_article_6_violation,
        test_commit_validator_article_6_compliant,
        test_commit_validator_empty_sections,
        test_pylint_plugin_safety_critical,
        test_pylint_plugin_compliant,
    ]
    ...
    if failed > 0:
        ...
        print(f"\n⚠️  {passed}/{total - skipped} tests passed (some skipped)")
        sys.exit(0)
