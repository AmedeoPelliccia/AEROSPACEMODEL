# AMPEL360 Transport / PORT-INS Framework

**Aircraft TLI v2.1 Canonical Architecture**  
**Program:** AMPEL360 Q100 (AIR-T) + Q10 PLUS (SPACE-T)  
**Authority:** ASIT (Aircraft Systems Information Transponder)

> **Migration notice:** The canonical path for this framework is
> `AMPEL360_Trans/PORT-INS_FRAMEWORK/`. The legacy `OPT-IN_FRAMEWORK/`
> directory exists in this branch for backward compatibility and will be
> removed once the full directory tree migration (git mv) is complete.
> New content for the **S-SIMTEST_DIGITAL_TWIN** and **R-RESERVED** axes
> should be placed under this canonical path.

---

## Overview

The **AMPEL360_Trans/PORT-INS_FRAMEWORK** provides the structural foundation for organizing ATA iSpec 2200-aligned content across the complete aircraft lifecycle (LC01–LC14).  
...
The AMPEL360_Trans/PORT-INS_FRAMEWORK is designed to support:
...
|---------|------|--------|-------------|
| 1.0.0 | 2026-02-12 | ASIT | Initial AMPEL360_Trans/PORT-INS_FRAMEWORK creation for TLI v2.1 |
...
*End of AMPEL360_Trans/PORT-INS_FRAMEWORK README*
