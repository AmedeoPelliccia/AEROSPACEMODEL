...
2. **Multi-line Sections:** Sections can span multiple lines and are captured until the next section header. Multi-line content is fully preserved and validated.

3. **Additional Sections:** You can add extra sections (e.g., `REFERENCES:`, `TESTING:`), and the five required sections must still be present.
