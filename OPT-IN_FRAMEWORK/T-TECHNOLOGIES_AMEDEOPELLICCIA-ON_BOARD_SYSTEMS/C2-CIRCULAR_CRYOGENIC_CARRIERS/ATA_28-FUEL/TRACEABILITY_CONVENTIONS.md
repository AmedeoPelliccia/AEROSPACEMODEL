...
> Relationship types and trace link semantics for ATA 28 Fuel System (LH₂).
...
REQ-Q100-C2-012,KNOT-ATA28-11-00-001,derives_from,up,Tank pressure requirement from KNOT,approved
DMC-Q100-A-28-11-00-00A-040A-A,REQ-Q100-C2-012,satisfies,up,Design description satisfies REQ,approved
TC-Q100-C2-012-01,REQ-Q100-C2-012,verifies,up,Pressure test verifies requirement,planned
```
...
```
KNOT-ATA28-11-00-001        (Knowledge Node – LH₂ Tank)
  └─► KNU-ATA28-11-00-001-01  (Knowledge Unit – Pressure Envelope)
        └─► REQ-Q100-C2-012     (Requirement – Max Operating Pressure)
              ├─► DES-Q100-C2-012  (Design – Tank Pressure Vessel)
              │     └─► IMP-Q100-C2-012  (Implementation – Tank Assembly)
              ├─► TC-Q100-C2-012-01  (Test Case – Pressure Test)
              └─► DMC-Q100-A-28-11-00-00A-040A-A  (Publication)
```
