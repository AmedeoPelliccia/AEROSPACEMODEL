...
**File**: `OPT-IN_FRAMEWORK/T-TECHNOLOGIES_AMEDEOPELLICCIA-ON_BOARD_SYSTEMS/C2-CIRCULAR_CRYOGENIC_CARRIERS/ATA_28-FUEL/WBS/WBS_LEVEL_2.yaml`
...
- `domain`: Technical domain (C2-CIRCULAR_CRYOGENIC_CARRIERS)
...
**File**: `OPT-IN_FRAMEWORK/T-TECHNOLOGIES_AMEDEOPELLICCIA-ON_BOARD_SYSTEMS/C2-CIRCULAR_CRYOGENIC_CARRIERS/ATA_28-FUEL/WBS/README.md`
...
### Modified
1. `OPT-IN_FRAMEWORK/T-TECHNOLOGIES_AMEDEOPELLICCIA-ON_BOARD_SYSTEMS/C2-CIRCULAR_CRYOGENIC_CARRIERS/ATA_28-FUEL/WBS/WBS_LEVEL_2.yaml` (321 lines added)

### Created
2. `scripts/generate_wbs_meta_files.py` (223 lines)
3. `OPT-IN_FRAMEWORK/T-TECHNOLOGIES_AMEDEOPELLICCIA-ON_BOARD_SYSTEMS/C2-CIRCULAR_CRYOGENIC_CARRIERS/ATA_28-FUEL/WBS/README.md` (213 lines)
