...
**Circular Cryogenic Carriers (LH₂) — General Storage Architecture**
...
|------|-------------|-------------------|
| `TS-28-10-TS01_geometry.yaml` | Circular vs Non-Circular Cryogenic Tanks | Circular Cryogenic Carrier (CCC) |
| `TS-28-10-TS02_distributed_architecture.yaml` | Distributed Small Cells vs Single Large Tank | Distributed Circular Cryogenic Carriers |
